# Support for Output Descriptors in Arielcoin Core

Since Arielcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Arielcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Arielcoin Core wallets, a convenience function `combo` is
