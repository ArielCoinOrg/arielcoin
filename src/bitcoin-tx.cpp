...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " arielcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  arielcoin-tx [options] <hex-tx> [commands]  Update hex-encoded arielcoin transaction\n" +
            "or:     arielcoin-tx [options] -create [commands]   Create hex-encoded arielcoin transaction\n" +
            "\n";
