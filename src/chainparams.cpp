...
public:
    CMainParams() {
        ...
        hashStateRoot = uint256(h256Touint(dev::h256("1656c3b91a1707248030d74f0ca29e6e966a70a3e208c537f3805cbac3e79e87"))); // ariel
...
public:
    CTestNetParams() {
        ...
        consensus.signet_blocks = false;
        consensus.signet_challenge.clear();
        consensus.nSubsidyHalvingInterval = 985500; // ariel halving every 4 years
        consensus.BIP16Height = 1;
...
public:
    ...
    : CRegTestParams(args)
    {
        ...
        // ARIEL have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
