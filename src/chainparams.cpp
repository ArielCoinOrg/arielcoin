...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1609074580, 34, 0x2001ffff, 1, 50 * COIN);
...
//        vSeeds.emplace_back("qtum7.dynu.net"); // Qtum mainnet
        ...
        checkpointData = {
            {
                { 0, uint256S("a04b0c9573c21311658ad15447d9a57fd9547263d11747e963f8b6353b6e4d04")}
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.BIP16Height = uint256S("0x0000e803ee215c0684ca0d2f9220594d3f828617972aad66feb2ba51f5e14222");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.signet_challenge.clear();
        consensus.nSubsidyHalvingInterval = 985500;
        consensus.BIP16Height = uint256S("0x665ed5b402ac0b44efc37d8926332994363e8a7278b7ee9a58fb972efadae943");
