...
/** Maximum length of incoming protocol messages (no message over 128 MB is currently acceptable). */
static const unsigned int MAX_PROTOCOL_MESSAGE_LENGTH = 128 * 1000 * 1000;
