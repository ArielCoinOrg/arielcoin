...
"""Verify that starting arielcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start arielcoin with -h for help text")
        ...
        self.log.info("Start arielcoin with -version for version information")
        ...
        self.log.info("Start arielcoind with -fakearg to make sure it does not start")
